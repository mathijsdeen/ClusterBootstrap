...
#' @description Obtain a matrix containing the \code{clusterid} values for the bootstrap samples in a \code{clusboot} object.
#' @param object object of class \code{clusboot}, created with the \code{clusbootglm} function.
