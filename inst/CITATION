citHeader("To cite the ClusterBootstrap package in publications, please use:")
...
citEntry(entry = "Article",
         ...
         author = personList(as.person("Deen, M."), as.person("de Rooij, M.")),
         journal = "Behavior Research Methods",
         year = "in press",
         url = "https://doi.org/10.3758/s13428-019-01252-y",
         textVersion = paste("Deen, M. & de Rooij, M. (in press).",
